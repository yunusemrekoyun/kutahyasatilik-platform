    ...
    <div className="mx-auto grid max-w-md px-4 py-16">
      <div className="rounded-control border border-stone bg-paper p-8">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-xl font-bold text-ink">Danışman Teklifiniz</h1>
          <p className="text-sm text-muted">E-posta ve telefonunuzun son 4 hanesiyle doğrulayın.</p>
        </div>
        <div className="mt-6">
          <OfferView />
        </div>
