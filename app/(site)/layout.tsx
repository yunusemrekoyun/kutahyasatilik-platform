...
export default async function SiteLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SiteContactProvider contact={contact}>
      <div className="classic-public flex min-h-screen flex-col">
        <a
          href="#main-content"
          className="fixed left-4 top-4 z-[120] -translate-y-24 rounded-lg bg-white px-4 py-3 font-semibold text-brand-950 shadow-prestige transition-transform focus:translate-y-0"
        >
          Ana içeriğe geç
        </a>
        <Header />
