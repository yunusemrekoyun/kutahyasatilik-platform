    ...
    <div className="mx-auto grid max-w-md px-4 py-16">
      <div className="rounded-control border border-stone bg-paper p-8">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-xl font-bold text-ink">Hesap Oluştur</h1>
          <p className="text-sm text-muted">Ücretsiz — favori ve kayıtlı aramalarınız cihazdan bağımsız saklanır.</p>
        </div>
        <div className="mt-6">
          <UserRegisterForm />
        </div>
