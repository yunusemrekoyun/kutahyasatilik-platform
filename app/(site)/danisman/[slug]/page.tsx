    ...
    <div>
      ...
      <header className="relative mt-5 overflow-hidden border-y border-stone bg-brand-950">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-8 px-5 py-10 sm:px-6 md:grid-cols-[auto_1fr] md:items-center md:py-14">
          <div className="grid h-36 w-36 place-items-center overflow-hidden rounded-control border-4 border-paper bg-paper text-brand-800 sm:h-44 sm:w-44">
            {photo ? (
          ...
          <div className="max-w-3xl text-white">
            <span className="inline-flex items-center gap-1 rounded-control border border-white/25 px-2.5 py-1 text-xs font-semibold">
              <ShieldCheck className="h-3.5 w-3.5 text-gold-300" /> Onaylı danışman
            </span>
            <h1 className="mt-3 text-4xl font-semibold leading-tight tracking-tight sm:text-5xl">{agent.name}</h1>
        ...
        <section className="grid gap-8 lg:grid-cols-12">
          <div className="lg:col-span-8">
            <div className="grid grid-cols-2 divide-x divide-stone border-y border-stone bg-paper sm:grid-cols-3">
              <div className="px-4 py-5 sm:px-6">
                ...
                <p className="mt-1 text-3xl font-semibold tabular-nums text-brand-950">{agent.listingCount}</p>
              </div>
              <div className="px-4 py-5 sm:px-6">
            ...
            <div className="mt-8 border-b border-stone pb-8">
              ...
              <h2 className="mt-2 text-3xl font-semibold text-brand-950">Sahadan bilgi, açık iletişim</h2>
              ...
              <div className="mt-8 border-b border-stone pb-8">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {agent.specialties.map((specialty) => (
                    <span key={specialty} className="rounded-control border border-stone bg-paper px-3 py-2 text-sm font-semibold text-ink">
                      {specialty}
                    </span>
                  ))}
                </div>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {agent.serviceDistricts.map((district) => (
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 rounded-control border border-stone bg-paper px-3 py-2 text-sm font-semibold text-brand-800 transition hover:border-brand-300"
                    >
          ...
          <aside className="lg:col-span-4">
            <div className="border border-stone border-t-[3px] border-t-gold-700 bg-paper p-6 lg:sticky lg:top-24">
              ...
              <h2 className="mt-2 text-2xl font-semibold text-brand-950">{agent.name}</h2>
        ...
        <section className="mt-16 border-t border-stone pt-10">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-semibold text-brand-950">Danışmanın aktif ilanları</h2>
            </div>
