...
export default async function AccountPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="mt-8">
        ...
        {leads.length === 0 ? (
          ...
          <div className="mt-3 space-y-3">
            {leads.map((l) => (
              <div key={l.id} className="rounded-xl bg-white p-5 ring-1 ring-slate-200">
      ...
      {/* Şifre değiştir */}
      <div className="mt-4 rounded-xl bg-white p-6 ring-1 ring-slate-200">
      ...
      <Link href="/hesabim/mesajlar" className="mt-4 flex items-center gap-3 rounded-xl bg-white p-5 ring-1 ring-slate-200 transition hover:shadow-card hover:ring-brand-300">
      ...
      <Link href="/favoriler" className="mt-4 flex items-center gap-3 rounded-xl bg-white p-5 ring-1 ring-slate-200 transition hover:shadow-card hover:ring-brand-300">
