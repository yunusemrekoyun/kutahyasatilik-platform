        ...
        <div className="relative min-h-56 overflow-hidden border border-stone bg-brand-950 sm:min-h-72">
          ...
          <div className="relative flex min-h-56 items-end p-5 sm:min-h-72 sm:p-8">
            <div className="flex max-w-4xl flex-col gap-5 sm:flex-row sm:items-end">
              <div className="grid h-24 w-24 shrink-0 place-items-center overflow-hidden rounded-control border-4 border-paper bg-paper text-2xl font-bold text-brand-800 sm:h-28 sm:w-28">
                {logo ? (
                  // eslint-disable-next-line @next/next/no-img-element
              ...
              <div className="pb-1 text-white">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {agency.verified ? (
                    <span className="inline-flex items-center gap-1 rounded-control bg-paper/95 px-2 py-1 text-xs font-semibold text-brand-800">
                      <BadgeCheck className="h-3.5 w-3.5" /> Doğrulanmış
                    </span>
                  ) : (
                    <span className="inline-flex items-center gap-1 rounded-control border border-white/30 px-2 py-1 text-xs font-semibold text-white">
        ...
        <section className="grid gap-8 lg:grid-cols-12">
          <div className="lg:col-span-8">
            <div className="grid grid-cols-2 divide-x divide-stone border-y border-stone bg-paper sm:grid-cols-3">
              <div className="px-4 py-5 sm:px-6">
                ...
                <p className="mt-1 text-3xl font-semibold tabular-nums text-brand-950">{agency.listingCount}</p>
              </div>
              <div className="px-4 py-5 sm:px-6">
                <p className="text-xs font-semibold uppercase tracking-wider text-muted">Danışman</p>
                <p className="mt-1 text-3xl font-semibold tabular-nums text-brand-950">{agency.agentCount}</p>
              </div>
            ...
            <div className="mt-8 border-b border-stone pb-8">
              ...
              <h2 className="mt-2 text-3xl font-semibold text-brand-950">Yerel uzmanlık, güncel portföy</h2>
              <p className="mt-4 max-w-3xl whitespace-pre-line text-base leading-8 text-ink">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {agency.serviceDistricts.map((district) => (
                    <Link
                      ...
                      className="rounded-control border border-stone bg-paper px-3 py-2 text-sm font-semibold text-brand-800 transition hover:border-brand-300"
                    >
                      {district}
                    </Link>
                  ))}
          ...
          <aside className="lg:col-span-4">
            <div className="border border-stone border-t-[3px] border-t-gold-700 bg-paper p-6 lg:sticky lg:top-24">
              ...
              <h2 className="mt-2 text-2xl font-semibold text-brand-950">{agency.name}</h2>
          ...
          <section className="mt-16 border-t border-stone pt-10">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <h2 className="mt-2 text-3xl font-semibold text-brand-950">Ofisin danışmanları</h2>
              </div>
        ...
        <section className="mt-16 border-t border-stone pt-10">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-semibold text-brand-950">Ofisin aktif ilanları</h2>
            </div>
