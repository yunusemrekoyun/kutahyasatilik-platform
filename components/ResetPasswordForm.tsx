...
export default function ResetPasswordForm() {
  ...
  if (!token) {
    return (
      <div role="alert" className="rounded-[10px] bg-red-50 p-4 text-center text-sm text-red-700 ring-1 ring-red-200">
        Geçersiz bağlantı.{" "}
        <Link href="/sifremi-unuttum" className="inline-flex min-h-11 items-center font-semibold underline">Yeniden iste</Link>
      </div>
    );
  }
