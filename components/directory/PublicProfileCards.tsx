  ...
  return (
    <article className="group relative flex h-full flex-col overflow-hidden border border-stone bg-paper transition hover:border-brand-300">
      <div className="relative aspect-[16/7] overflow-hidden border-b border-stone bg-brand-950">
        ...
        {agency.verified ? (
          <span className="absolute right-3 top-3 inline-flex items-center gap-1 rounded-control bg-paper/95 px-2 py-1 text-[11px] font-bold text-brand-800">
      ...
      <div className="relative flex flex-1 flex-col px-5 pb-5 pt-10">
        <div className="absolute -top-8 left-5 grid h-16 w-16 place-items-center overflow-hidden rounded-control border-4 border-paper bg-canvas text-lg font-bold text-brand-800">
          {logo ? (
            // eslint-disable-next-line @next/next/no-img-element
        ...
        <h2 className="mt-2 text-2xl font-semibold leading-tight text-brand-950">
        ...
        {agency.description ? (
          <p className="mt-4 line-clamp-3 text-sm leading-6 text-muted">{agency.description}</p>
        ) : (
        ...
        <div className="relative mt-5 flex flex-wrap gap-x-5 gap-y-2 border-t border-stone pt-4 text-sm text-muted">
  ...
  return (
    <article className="group relative flex h-full flex-col border border-stone bg-paper p-5 transition hover:border-brand-300">
      <div className="flex items-start gap-4">
        <div className="grid h-20 w-20 shrink-0 place-items-center overflow-hidden rounded-control bg-brand-50 text-xl font-bold text-brand-800">
          {logo ? (
            // eslint-disable-next-line @next/next/no-img-element
        ...
        <div className="min-w-0 pt-1">
          ...
          <h2 className="mt-1 text-xl font-semibold leading-tight text-brand-950">
      ...
      {agent.bio ? (
        <p className="mt-4 line-clamp-3 text-sm leading-6 text-muted">{agent.bio}</p>
      ) : null}

      <div className="relative mt-auto flex flex-wrap gap-x-5 gap-y-2 border-t border-stone pt-4 text-sm text-muted">
  ...
  return (
    <div className="flex flex-wrap gap-2">
      {phoneHref ? (
        <a
          href={phoneHref}
          className="inline-flex min-h-11 items-center gap-2 rounded-control bg-brand-700 px-4 text-sm font-semibold text-white transition hover:bg-brand-800"
        >
      ...
      {whatsappHref ? (
        <a
          ...
          className="inline-flex min-h-11 items-center gap-2 rounded-control border border-brand-200 bg-paper px-4 text-sm font-semibold text-brand-800 transition hover:border-brand-400"
        >
      ...
      {website ? (
        <a
          ...
          className="inline-flex min-h-11 items-center gap-2 rounded-control border border-stone bg-paper px-4 text-sm font-semibold text-ink transition hover:border-brand-300"
        >
