      ...
      <div className="mt-7 flex flex-col items-center justify-center gap-3 sm:flex-row">
        ...
        {c.phoneRaw && (
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-[10px] bg-paper/10 px-6 py-3.5 font-semibold text-white ring-1 ring-white/25 transition hover:bg-paper/20 sm:w-auto"
          >
