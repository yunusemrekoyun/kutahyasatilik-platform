...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-5 lg:bottom-5 z-40 hidden sm:flex h-14 w-14 items-center justify-center rounded-full bg-green-600 text-white shadow-xl ring-4 ring-green-600/20 transition hover:scale-110 hover:bg-green-700"
    >
